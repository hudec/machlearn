...
def max_comp_value_diff1(values):
    max_value, diff_value, sel_value1, sel_value2 = None, None, None, None
    for i, value1 in enumerate(values):
        for value2 in values[i:]:
            if max_value is None:
                max_value, diff_value, sel_value1, sel_value2 = abs(value1 - value2), value1 - value2, value1, value2
                continue
            value = value1 - value2
#             if value.real <= diff_value.real and value.imag <= diff_value.imag:
#                 continue
#             if value.real > diff_value.real and value.imag > diff_value.imag:
#                 max_value, diff_value, sel_value1, sel_value2 = abs(value), value, value1, value2
#                 continue
            comp_value = abs(value)
            if comp_value > max_value:
                max_value, diff_value, sel_value1, sel_value2 = comp_value, value, value1, value2
    return max_value, sel_value1, sel_value2
